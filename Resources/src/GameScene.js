...
var Game = cc.Layer.extend({
    ...
    init: function () {
        ...
        soapScoreSprite.setPosition(screenSize.width / 10, screenSize.height / 1.2);
        lazyLayer.addChild(soapScoreSprite, 5);


        soapScoreLabel = cc.LabelTTF.create(soapScoreNum.toString(), "Arial", 30);
        soapScoreLabel.setPosition(screenSize.width / 4, screenSize.height / 1.2);
...
var GameOver = function()
{
    ...
    gameOverSprite.setPosition(screenSize.width / 2, screenSize.height / 1.4);
